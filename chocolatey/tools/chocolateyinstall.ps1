...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url64bit       = 'https://download.lrgex.com/app/rst/lrgex-compress/LRGEX-Compress-v1.7.3-setup.exe'
  checksum64     = '404c0a052bfc714167ffd6d1d281159ad7f73b8fe248ecc9a680b4f715027e28'
