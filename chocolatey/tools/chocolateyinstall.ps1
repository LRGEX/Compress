...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url64bit       = 'https://download.lrgex.com/app/rst/lrgex-compress/LRGEX-Compress-v1.5.1-setup.exe'
  checksum64     = 'a71b8a7f5f126e7dbcb3b8185d7953449f324f6e52bfb8008700ac08439cc02c'
