...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url64bit       = 'https://download.lrgex.com/app/rst/lrgex-compress/LRGEX-Compress-v1.9.0-setup.exe'
  checksum64     = '8c029c091f5e1c95797c1584c0a13c14a00f5a441f485fb68c4fdbe7347973e1'
